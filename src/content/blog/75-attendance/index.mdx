...
my college has strict rules for attendance. they often check for proxies. it is
mostly a school at this point. there is no room for learning by our own at this
point. so i had to learn new things otherwise i will get some basic ass package
from on-campus placement. so here are the few things that i follow to get
maximum amount of free time from the college.
